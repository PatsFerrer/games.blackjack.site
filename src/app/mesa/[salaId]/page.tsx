...
import { EventosContext, EventosProvider } from "@/context/EventosContext";
...
const EventosDisplay: React.FC = () => {
  const context = useContext(EventosContext);
  if (!context) {
    throw new Error('EventosDisplay must be used within a EventosProvider');
  }
